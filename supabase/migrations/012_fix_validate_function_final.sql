-- Migration 012: Final fix for validate_apartment_credentials function
-- Drops old broken function and recreates with proper aliases
...
-- Create fixed function with explicit table alias and AS aliases
...
BEGIN
  ...
  -- Return apartment info (without PIN hash) with explicit AS aliases
  RETURN QUERY SELECT
