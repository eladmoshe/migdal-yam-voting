-- ============================================
-- RESET APARTMENT PIN FUNCTION
-- Admin function to reset PIN for existing apartments
-- ============================================
...
BEGIN
  ...
  -- Check if apartment exists and get its details
  SELECT id, owner_name
  INTO v_apartment_id, v_owner_name
  FROM apartments
  ...
  -- Log successful PIN reset (without plaintext PIN)
  PERFORM log_audit_event(
    'admin',
    v_user_id::TEXT,
    v_user_email,
  ...
  -- Return apartment info and plaintext PIN (ONE TIME ONLY)
...
GRANT EXECUTE ON FUNCTION reset_apartment_pin TO authenticated;
