...
CREATE OR REPLACE FUNCTION create_apartment(
  ...
  p_owner_name TEXT,
  p_phone_number_1 TEXT DEFAULT NULL,
  p_owner_name_1 TEXT DEFAULT NULL,
  p_phone_number_2 TEXT DEFAULT NULL,
  p_owner_name_2 TEXT DEFAULT NULL
)
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  -- Insert the apartment with phone numbers and owner names
  INSERT INTO apartments (number, owner_name, pin_hash, phone_number_1, owner_name_1, phone_number_2, owner_name_2)
  VALUES (p_apartment_number, p_owner_name, v_pin_hash, p_phone_number_1, p_owner_name_1, p_phone_number_2, p_owner_name_2)
  RETURNING id INTO v_apartment_id;

  -- Log successful apartment creation (without plaintext PIN, but with phone numbers if provided)
  PERFORM log_audit_event(
    'admin',
    v_user_id::TEXT,
    v_user_email,
    ...
    jsonb_build_object(
      ...
      'has_phone_1', p_phone_number_1 IS NOT NULL,
      'has_phone_2', p_phone_number_2 IS NOT NULL
    )
  );

  -- Return apartment_id, phone numbers with owner names, and plaintext PIN (ONE TIME ONLY)
  -- This is the ONLY time the plaintext PIN is ever exposed
  RETURN jsonb_build_object(
    'apartment_id', v_apartment_id,
    'apartment_number', p_apartment_number,
    'owner_name', p_owner_name,
    'phone_number_1', p_phone_number_1,
    'owner_name_1', p_owner_name_1,
    'phone_number_2', p_phone_number_2,
    'owner_name_2', p_owner_name_2,
    'pin', v_plaintext_pin
  );
END;
$$;
